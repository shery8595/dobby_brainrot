  ...
  try {
    ...
    const response = await fetch('https://api.fireworks.ai/inference/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `You are Rick Sanchez from Rick and Morty. Summarize the following document in your unique, snarky, and brilliant style. Keep it concise, under 200 words, and explain it like you're talking to Morty. Get to the point, and don't bore me with fluff! Document: ${truncatedText}`,
        }],
        max_tokens: 300,
        temperature: 0.9,
      }),
